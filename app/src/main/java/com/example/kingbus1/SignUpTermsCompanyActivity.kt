...
class SignUpTermsCompanyActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sign_up_accept_terms_company)
        ...
        agreeButton.setOnClickListener {
            ...
            if (everyAcceptTermsCheckBox.isChecked) {
                ...
                val intent = Intent(this, SignUpCompanyInfoActivity::class.java)
